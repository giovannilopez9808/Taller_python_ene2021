...
class Grafica(GraphScene):
    CONFIG = {
        ...
        "x_tick_frequency" : 0.5, #Subdivisiones de x
        "axes_color" : BLUE, #Color de los ejes XY
        "y_labeled_nums": range(30,60,10),
        "x_labeled_nums": list(np.arange(2.5, 7.0+0.5, 0.5)),
        "x_decimal_config":1,
    ...
    def construct(self):
        self.setup_axes(animate=False) #animate=True para animar al mostrar los ejes
...
class Grafica6(GraphScene):
    ...
    def setup_axes(self):
        ...
        valor_decimal_x=[0,0.5,1,1.5,3.35]
        # Lista de etiquetas
        lista_x = [*["%s"%i for i in valor_decimal_x]]
