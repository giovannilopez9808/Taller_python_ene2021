...
class AnimacionSVG(FourierFromSVG):
    CONFIG = {
        #"slow_factor": 0.05,
        "n_vectors": 100,
        "n_cycles": 1,
        "file_name": "nota_sol_2",
...
class introprotofisico(FourierOfPaths):
...
#python -m manim example_fourier_series.py introprotofisico -o ddf


class OpeningProto(Scene):
    def construct(self):
        title = TextMobject("@Protofisico")
        basel = TextMobject(" Ahora en Facebook ")
        ...
        transform_title = TextMobject(" Continuaremos divulgando la ciencia ")
        transform_title.to_corner(UP + LEFT)
        contenido = TextMobject(' Fisica, matematicas y programacion ')
